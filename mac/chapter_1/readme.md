...
Now your changes are in github but how do you merge them into the master version so everyone can now get the latest and greatest. Well go to the original repo for this tutorial. Click on the `Pull requests` tab and create a new pull request. Admins in the repo can then look at the changes and approve the pull request if they like the additions. They may also request some changes 
