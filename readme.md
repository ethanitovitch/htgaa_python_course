...
- This repository (or repo as we call it) is split into different folders where each folder is a chapter. Each chapter has its own readme with instructions and Exercises to follow. The chapters build on top of each other but feel free to go through them however you want.
